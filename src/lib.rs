...
#[derive(Debug)]
pub struct ChainOrbitProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainOrbitProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainOrbit processing");
    
    let mut processor = ChainOrbitProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainOrbitProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainOrbitProcessor::new(false);
